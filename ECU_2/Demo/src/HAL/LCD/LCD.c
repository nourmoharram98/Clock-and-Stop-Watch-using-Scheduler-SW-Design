...
/*------------------------------------static functions------------------------------------*/
    ...
    static LCD_enuErrorStatus_t LCD_enuWriteData     (U8 Copy_u8Data);
        ...
        static void LCD_Init_Manager                 (void);
            ...
            static GPIO_enuErrorStatus LCD_IMH_PowerOn(void);
...
/*-------------------------------------Static functions---------------------------------*/
    ...
    /*-----------------------------------LCD PowerOn-------------------------------*/
        static GPIO_enuErrorStatus LCD_IMH_PowerOn(void)
        {
            ...
            for (Index = 0 ; Index < LCD_PINs ; Index ++)
            {
                ...
                LCD.Pin = LCD_strLCDpinConfig[Index].LCD_PinNumber;
    ...
    /*----------------------------------Write Command------------------------------*/
        static LCD_enuErrorStatus_t LCD_enuWriteCommand(U8 Copy_u8Command)
        {
            ...
            GPIO_enuErrorStatus GPIO_Error_1 = GPIO_enuNotOK;
            GPIO_enuErrorStatus GPIO_Error_2 = GPIO_enuNotOK;
            GPIO_enuErrorStatus GPIO_Error_3 = GPIO_enuNotOK;
            ...
            switch (G_LCD_EnablePinState)
            {
                case LCD_EnablePin_OFF:
                    ...
                    /*Registers Set*/
                        GPIO_Error_1 = GPIO_SetPinValue ( LCD_strLCDpinConfig [ RS ] .LCD_PortNumber , LCD_strLCDpinConfig [ RS ] .LCD_PinNumber , GPIO_STATE_RESET );
                        GPIO_Error_2 = GPIO_SetPinValue ( LCD_strLCDpinConfig [ RW ] .LCD_PortNumber , LCD_strLCDpinConfig [ RW ] .LCD_PinNumber , GPIO_STATE_RESET );
                    /*-------------*/ 
                    ...
                    for (int LCD_iter = 3; LCD_iter < LCD_PINs; LCD_iter++)
                        {
                            ...
                            GPIO_Error_3 = GPIO_SetPinValue( LCD_strLCDpinConfig[ LCD_iter ].LCD_PortNumber , LCD_strLCDpinConfig[ LCD_iter ].LCD_PinNumber , Local_Data_bit );		
                        }
                    /*-------------*/
                    ...
                    /*--------Error return Mechanism--------*/
                        if (GPIO_Error_1 != GPIO_enuOK || GPIO_Error_2 != GPIO_enuOK || GPIO_Error_3 != GPIO_enuOK ) 
                        {
        ...
        static LCD_enuErrorStatus_t LCD_enuWriteData(U8 Copy_u8Data)
        {
            ...
            switch (G_LCD_EnablePinState)
            {
                case LCD_EnablePin_OFF :
                    ...
                    /*Registers Set*/
                        GPIO_Error_1 = GPIO_SetPinValue ( LCD_strLCDpinConfig [ RS ] .LCD_PortNumber , LCD_strLCDpinConfig [ RS ] .LCD_PinNumber , GPIO_STATE_SET );
                        GPIO_Error_2 = GPIO_SetPinValue ( LCD_strLCDpinConfig [ RW ] .LCD_PortNumber , LCD_strLCDpinConfig [ RW ] .LCD_PinNumber , GPIO_STATE_RESET );
                    /*-------------*/
                    ...
                    for (Data_Iter = 0 ; Data_Iter<8 ; Data_Iter++)
                    {
                        ...
                        /*Set needed Bit*/
                            GPIO_Error_3 = GPIO_SetPinValue ( LCD_strLCDpinConfig [ Data_Iter+3 ] .LCD_PortNumber , LCD_strLCDpinConfig [ Data_Iter+3 ] .LCD_PinNumber , Local_Data_Bit );
                        /*-------------*/
                    }
                    /*---------*/
    ...
    /*----------------------------------CtrlEnablePin------------------------------*/
        static void LCD_CtrlEnablePin(U8 Copy_LCDEnablePinState)
        {
            ...
            GPIO_SetPinValue(LCD_strLCDpinConfig[ ET ].LCD_PortNumber, LCD_strLCDpinConfig[ ET ].LCD_PinNumber, Copy_LCDEnablePinState);
        }
    /*-----------------------------------------------------------------------------*/  
